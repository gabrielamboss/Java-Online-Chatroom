...
public class ClientGUI extends JFrame implements ActionListener, KeyListener {
	...
	public static boolean challengeConfirm(String sender){
		if(JOptionPane.showConfirmDialog(null, "User " + sender + " has challenged you to a battle on Pok̩mon Showdown. Accept?", "Incoming challenge", JOptionPane.YES_NO_OPTION) == 0)
			return true;
		else
			return false;
	}
